...
/**
 * Utility methods for sending requests to a url resource
 * request methods such as post, get, delete and put returns HttpResponse
 * Content can be easily resolved using to String HttpUtil.getContent
 *
 * @author chazz
 *
 */
